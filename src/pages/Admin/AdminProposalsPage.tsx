                    ...
                    <Col xs={24} sm={12} md={6}>
                        <Card variant="borderless" className="text-center">
                            <Statistic
                                ...
                                value={extractionStats.totalPreferences}
                    ...
                    <Col xs={24} sm={12} md={6}>
                        <Card variant="borderless" className="text-center">
                            <Statistic
                                ...
                                value={extractionStats.extractionMethods?.['nlp-extraction'] || 0}
                    ...
                    <Col xs={24} sm={12} md={6}>
                        <Card variant="borderless" className="text-center">
                            <Statistic
                                ...
                                value={extractionStats.extractionMethods?.['manual'] || 0}
                                prefix={<UserOutlined />}
                    ...
                    <Col xs={24} sm={12} md={6}>
                        <Card variant="borderless" className="text-center">
                            <Statistic
                                ...
                                value={extractionStats.averageConfidence}
                                suffix="%"
