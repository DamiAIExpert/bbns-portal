...
const BlockchainLogsPage: React.FC = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      const [logsData, summaryData, transactionsData] = await Promise.all([
        ...
        <Row gutter={[16, 16]} style={{ marginBottom: '24px' }}>
          <Col xs={24} sm={12} md={6}>
            <Card>
              <Statistic
                ...
                value={blockchainSummary.totalTransactions}
          ...
          <Col xs={24} sm={12} md={6}>
            <Card>
              <Statistic
                title="Successful"
                value={blockchainSummary.successfulTransactions}
          ...
          <Col xs={24} sm={12} md={6}>
            <Card>
              <Statistic
                title="Failed"
                value={blockchainSummary.failedTransactions}
          ...
          <Col xs={24} sm={12} md={6}>
            <Card>
              <Statistic
                ...
                value={blockchainSummary.totalProposalsStored}
