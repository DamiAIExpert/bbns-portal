        ...
        <Row gutter={[16, 16]} style={{ marginBottom: '24px' }}>
            ...
            <Card title="Database Status">
              ...
              <Descriptions size="small" column={1}>
                <Descriptions.Item label="Proposals">
                  {(systemInfo.database.collections.proposals || 0).toLocaleString()}
                </Descriptions.Item>
                <Descriptions.Item label="Users">
                  {(systemInfo.database.collections.users || 0).toLocaleString()}
                </Descriptions.Item>
                <Descriptions.Item label="Negotiations">
                  {(systemInfo.database.collections.negotiations || 0).toLocaleString()}
                </Descriptions.Item>
                <Descriptions.Item label="Blockchain Stored">
                  {(systemInfo.database.collections.blockchainStored || 0).toLocaleString()}
                </Descriptions.Item>
              </Descriptions>
            </Card>
          </Col>
            ...
            <Card title="System Information">
              <Descriptions size="small" column={1}>
                ...
                <Descriptions.Item label="Environment">
                  <Tag color="blue">{systemInfo.system.environment}</Tag>
                </Descriptions.Item>
              ...
              <div style={{ marginTop: '8px' }}>
                <Progress
                  percent={systemInfo.system.memoryUsage?.heapTotal ? 
                    Math.round((systemInfo.system.memoryUsage.heapUsed / systemInfo.system.memoryUsage.heapTotal) * 100) : 0}
                  size="small"
                  strokeColor="#1890ff"
                />
                <Text type="secondary" style={{ fontSize: '12px' }}>
                  {formatMemoryUsage(systemInfo.system.memoryUsage?.heapUsed || 0)} / {formatMemoryUsage(systemInfo.system.memoryUsage?.heapTotal || 0)}
                </Text>
              </div>
            </Card>
          </Col>
          <Col xs={24} md={8}>
            <Card title="Blockchain Status">
              <Statistic
                title="Status"
                value={systemInfo.blockchain.status}
                valueStyle={{ color: '#52c41a' }}
              />
              <Divider />
              <Descriptions size="small" column={1}>
                <Descriptions.Item label="Total Transactions">
                  {(systemInfo.blockchain.totalTransactions || 0).toLocaleString()}
                </Descriptions.Item>
