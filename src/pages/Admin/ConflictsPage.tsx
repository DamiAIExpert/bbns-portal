...
const ConflictsPage: React.FC = () => {
    ...
    const fetchData = async () => {
        try {
            ...
            const [conflictsData, proposalsData, statsData] = await Promise.all([
                getAllConflicts(),
                getProposalsWithConflicts(),
                fetchConflictStats()
            ]);
    ...
    return (
        <div style={{ padding: '24px' }}>
                ...
                <Col xs={24} sm={6}>
                    <Card>
                        <Statistic 
                            ...
                            value={conflictStats?.total || proposalsWithConflicts?.conflictSummary?.totalConflicts || 0}
                ...
                <Col xs={24} sm={6}>
                    <Card>
                        <Statistic 
                            ...
                            value={conflictStats?.resolved || proposalsWithConflicts?.conflictSummary?.resolvedConflicts || 0}
                ...
                <Col xs={24} sm={6}>
                    <Card>
                        <Statistic 
                            ...
                            value={conflictStats?.open || proposalsWithConflicts?.conflictSummary?.openConflicts || 0}
            ...
            <Card>
                ...
                <TabPane tab="Conflict Analytics" key="analytics">
                    <Row gutter={[16, 16]}>
                        <Col xs={24} lg={12}>
            ...
            <Modal
                ...
                width={800}
            >
                <Tabs defaultActiveKey="detection">
                    <TabPane tab="Conflict Detection" key="detection">
                        <Form
                            layout="vertical"
                    ...
                    <TabPane tab="Requirements Extraction" key="requirements">
                        <Form
                            layout="vertical"
