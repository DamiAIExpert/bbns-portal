...
const NegotiationsPage: React.FC = () => {
    ...
    const columns = [
        ...
        },
        {
            ...
            key: 'ttc',
            render: (ttc: number) => ttc ? Math.round(ttc) : 'N/A',
            width: 100
        },
        {
            title: 'Rounds',
        ...
        },
        {
            ...
            key: 'satisfaction',
            render: (satisfaction: number) => satisfaction ? `${Math.round(satisfaction)}/10` : 'N/A',
            width: 100
        },
        {
            title: 'Created',
    ...
    const getStats = () => {
        ...
        const completed = negotiations.filter(n => ['finalized', 'completed', 'success'].includes(n.status)).length;
        const avgTTC = negotiations.length > 0 
