...
const adminMenuItems: MenuProps['items'] = [
  ...
  { key: '/admin/real-time-analytics', icon: <BarChartOutlined />, label: <NavLink to="/admin/real-time-analytics">Real-Time Analytics</NavLink> },
  { key: '/admin/research-analytics', icon: <ExperimentOutlined />, label: <NavLink to="/admin/research-analytics">Research Analytics</NavLink> },
